...
import {
	...
	PropertyImage,
	GetNewPropertiesResponse,
	PropertyPreviewResponse,
	HidePropertyResponse,
	HidePropertyRequest,
...
export class PropertiesService {
	...
	public async getPendingProperties(): Promise<any> {
		const result = await this.restService.getWithAccessToken(this.apiEndpoint.INTERNAL_ENDPOINTS.GET_PENDING_PROPERTIES);
		return result.data.data;
	}
	...
	public async socialMediaShare(propertyId: string) {
		const params = {
			propertyId
		};
